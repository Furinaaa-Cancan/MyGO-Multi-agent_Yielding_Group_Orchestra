...
基于 **LangGraph 单一状态源（SSOT）** 驱动 4 节点工作流。v0.12.0
...
**MyGO — Multi-agent Yielding Group Orchestra** is your AI band for code delivery (v0.12.0).
...
- 1334 tests, full mypy/ruff compliance
