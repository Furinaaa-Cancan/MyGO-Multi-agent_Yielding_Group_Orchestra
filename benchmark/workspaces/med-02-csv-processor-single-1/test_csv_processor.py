"""Basic tests for csv_processor module."""
...
class TestFilterRows:
    ...
    def test_filter_no_match(self, sample_data):
        assert filter_rows(sample_data, "city", "Chicago") == []
...
class TestAggregate:
    ...
    def test_avg(self, sample_data):
        assert float(aggregate(sample_data, "age", "avg")) == 30.0
